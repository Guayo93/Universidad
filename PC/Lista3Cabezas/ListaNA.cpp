...
template <class T>
void agregarNodoNombre(Lista<T>* lista, Nodo<T>* nodo)
{
    ...
    {
        Nodo<T>* temp = lista->cabN;

        if(strcmp(temp->info->nombre, nodo->info->nombre) > 0)
        {
            nodo->sigN = temp;
        ...
        else
        {
            ...
            while(ingreso == false)
            {
                ...
                if(strcmp(temp->sigN->info->nombre, nodo->info->nombre) > 0 && ingreso == false)
                {
                    nodo->sigN = temp->sigN;
