...
int torreAMover(stack<int> torre1, stack<int> torre2, stack<int> torre3, int ultimaTorre, int nDiscos)
{
    if(ultimaTorre == 1)
    {
        if(torre2.empty() && torre3.empty())
        {
            return 1;
        }
        else
...
int moverInpar(stack<int> &torre1, stack<int> &torre2, stack<int> &torre3, int tAMover, int nDiscos)
{
    if(tAMover == 1)
    {
...
int moverPar(stack<int> &torre1, stack<int> &torre2, stack<int> &torre3, int tAMover, int nDiscos)
{
    if(tAMover == 1)
    {
        int discoActual = torre1.top();
...
int main()
{
    ...
    if(numDiscos % 2 == 1)
    {
        ...
        {
            cout << "Paso #" << cont << endl;
            int tAMover = torreAMover(torre1, torre2, torre3, ultimaTorre, numDiscos + 1);
            ultimaTorre = moverInpar(torre1, torre2, torre3, tAMover, numDiscos + 1);
            estadoActual(torre1, torre2, torre3);
            cont++;
            cout << endl;
        }
    ...
    else
    {
        while(torre1.empty() == false || torre2.empty() == false)
        {
            cout << "Paso #" << cont << endl;
            int tAMover = torreAMover(torre1, torre2, torre3, ultimaTorre, numDiscos + 1);
            ultimaTorre = moverPar(torre1, torre2, torre3, tAMover, numDiscos + 1);
            estadoActual(torre1, torre2, torre3);
            cont++;
            cout << endl;
        }
